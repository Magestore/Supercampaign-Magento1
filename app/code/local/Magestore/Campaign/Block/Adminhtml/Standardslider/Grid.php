 ...
 */
class Magestore_Campaign_Block_Adminhtml_Standardslider_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareCollection(){
		$collection = Mage::helper('campaign')->getStandardSlider();
	...
	protected function _prepareColumns(){
		$this->addColumn('title', array(
			'header'	=> Mage::helper('campaign')->__('List Slider'),
			'align'	 =>'left',
			'index'	 => 'title',
		...
		$this->addColumn('action',
			array(
				'header'	=>	Mage::helper('campaign')->__('Preview'),
				'width'		=> '100',
				'type'		=> 'action',
				'getter'	=> 'getId',
				'actions'	=> array(
