 ...
 */
class Magestore_Campaign_Block_Adminhtml_Report_Banner_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addExportType('*/*/exportCsvBanner', Mage::helper('campaign')->__('CSV'));
        $this->addExportType('*/*/exportXmlBanner', Mage::helper('campaign')->__('XML'));
    ...
    public function getCsv() {
        ...
        foreach ($this->getCollection() as $item) {
            $data = Mage::helper('campaign')->getValueToCsv($item, 1);
            $csv.= $data . "\n";
        }
        return $csv;
    }
