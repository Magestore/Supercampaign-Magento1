...
class Magestore_Campaign_Block_Adminhtml_Banner_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('campaign')->__('Banner Item'));
    }
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('general', array(
            'label'     => Mage::helper('campaign')->__('Banner Item infomation'),
            'title'     => Mage::helper('campaign')->__('Banner Item infomation'),
