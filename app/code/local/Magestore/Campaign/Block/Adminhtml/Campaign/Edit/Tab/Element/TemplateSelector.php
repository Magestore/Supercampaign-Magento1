 ...
 */
class Magestore_Campaign_Block_Adminhtml_Campaign_Edit_Tab_Element_TemplateSelector extends Varien_Data_Form_Element_Abstract
{
    ...
    {
        $html = '<input type="hidden" id="'.$this->getHtmlId().'" name="'.$this->getHtmlId().'" />';
        $html .= '<div '.$this->serialize($this->getHtmlAttributes()).'>'."\n";
