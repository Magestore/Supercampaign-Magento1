 ...
 */
class Magestore_Campaign_Block_Adminhtml_Campaign_Edit_Tab_BannerGrid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if(!isset($filter)){//if reset no filter
            ...
            if(!empty($selected_id)){
                $collection->addFieldToFilter('widget_banner_id', array('in'=>$selected_id));
            }
        }
    ...
    public function getGridUrl() {
        return $this->getUrl('*/adminhtml_banner/getBannerGrid');
    }
