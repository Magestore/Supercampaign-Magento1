 ...
 */
class Magestore_Campaign_Block_Adminhtml_Campaign_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            function saveAndContinueEdit(){
                return editForm.submit($('edit_form').action+'back/edit/');
            }
    ...
    public function getHeaderText()
    {
        if (Mage::registry('campaign_data')
            ...
            return Mage::helper('campaign')->__("Edit campaign '%s'",
                                                $this->htmlEscape(Mage::registry('campaign_data')->getName())
            );
        }
        return Mage::helper('campaign')->__('Add new Campaign');
    }
}