 ...
 */
class Magestore_Campaign_Block_Adminhtml_Popup_Overview_Template extends Mage_Core_Block_Template
{
    ...
    protected function _isLoadJs(){
        if(Mage::registry('campaign_popup_isLoadJs_overview')){
            return true;
        }
        return false;
    }
    ...
    protected function _setIsLoadJs($flag = true){
        Mage::register('campaign_popup_isLoadJs_overview', 1);
        return $this;
    }

    protected function _prepareLayout(){
        $this->setTemplate('campaign/popup_overview.phtml');
        return $this;
    }
}