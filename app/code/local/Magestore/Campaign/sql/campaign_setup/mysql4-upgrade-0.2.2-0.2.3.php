...
INSERT INTO `magestore_campaign_template` (`template_id`, `title`, `popup_type`, `template_code`, `template_file`, `preview_image`, `width`, `width_unit`, `corner_style`, `corner_radius`, `border_color`, `border_size`, `overlay_color`, `popup_background`, `padding`, `close_style`, `has_shadow`, `appear_effect`, `custom_css`, `position_to`, `position_px`, `horizontal_position`, `horizontal_px`, `vertical_position`, `vertical_px`, `position_element_id`) VALUES
