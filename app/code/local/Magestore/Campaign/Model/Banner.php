 ...
 */
class Magestore_Campaign_Model_Banner extends Mage_Core_Model_Abstract {
    ...
    public function _construct() {
        ...
        $this->_init('campaign/banner');//banner_item
    }

    protected function _beforeSave() {
        if ($storeId = $this->getStoreId()) {
            $defaultStore = Mage::getModel('campaign/banner')->load($this->getId());
    ...
    protected function _afterSave() {
        if ($storeId = $this->getStoreId()) {
            ...
            foreach ($storeAttributes as $attribute) {
                $attributeValue = Mage::getModel('campaign/value')
