 ...
 */
class Magestore_Campaign_Model_Resource_Banner_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function addFieldToFilter($field, $condition = null) {
        ...
        if (in_array($field, $attributes) && $storeId) {
            if (!in_array($field, $this->_addedTable)) {
                $this->getSelect()
                        ->joinLeft(array($field => $this->getTable('campaign/value')), "main_table.banner_id = $field.banner_id" .
